# grunt-steps : 03 - avançado ([en](README.md))
...
> - as configurações das tarefas do grunt estão definidas nas [linhas 14-27 do Gruntfile.js](Gruntfile.js#L14-L27)
>   - as configurações das tarefas do grunt estão separadas por arquivos no [diretório ./grunt/config_task](grunt/config_task) e carregadas na [linha 25 do Gruntfile.js](Gruntfile.js#L25)
>   - as principais configurações do projeto estão centralizadas no [./grunt/config.js](grunt/config.js) e adicionado nas configurações do grunt na [linha 20 do Gruntfile.js](Gruntfile.js#L20)
> - as tarefas customizadas do grunt estão definidas nas [linhas 29-93 do Gruntfile.js](Gruntfile.js#L29-L93)
> - as principais tarefas e a default(padrão) do grunt estão definidas nas [linhas 75-91 do Gruntfile.js](Gruntfile.js#L75-L91)
